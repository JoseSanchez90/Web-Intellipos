...
function Navbar() {
  ...
  const InactiveLinkSol = "relative group font-bold flex flex-row items-center gap-"
  ...
  <div className={`hidden w-full fixed top-0 z-10 md:flex flex-row justify-between items-center bg-white transition-all duration-500 ${isScrolled ? "shadow-lg rounded-full bg-slate-100 px-20 py-4 text-sm my-2 mx-2 w-[95%] transform translate-x-7" : "px-10 py-8 text-base"}`}>
    ...
    <div className="font-semibold flex gap-12 items-center">
      ...
      <div className="relative group">
        ...
        <NavLink to="/soluciones" className={({ isActive }) => isActive ? ActiveLinkSol : InactiveLinkSol}>Soluciones
