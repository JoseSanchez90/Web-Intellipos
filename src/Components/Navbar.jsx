...
function Navbar() {
  ...
  <div className="flex justify-center">
    <div className={`hidden fixed top-0 z-10 md:flex flex-row justify-between items-center bg-white transition-all duration-500 ${isScrolled ? "shadow-xl rounded-full bg-slate-100 px-20 py-4 text-sm my-2 mx-2 w-[85%] transform" : "px-12 md:px-14 2xl:px-10 md:py-6 2xl:py-8 text-base w-full"}`}>
