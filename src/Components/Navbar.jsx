...
function Navbar() {
  ...
  <div className={`hidden w-full fixed top-0 z-10 md:flex flex-row justify-between items-center bg-white transition-all duration-500 ${isScrolled ? "shadow-lg rounded-full bg-slate-100 px-20 py-4 text-sm my-2 mx-2 w-[90%] transform translate-x-16" : "px-10 py-8 text-base"}`}>
