...
function Navbar() {
  ...
  <div className={`hidden w-full fixed top-0 z-10 md:flex flex-row justify-between items-center bg-white transition-all duration-500 ${isScrolled ? "shadow-lg rounded-full bg-slate-100 px-20 py-4 text-sm my-2 mx-2 w-[85%] 2xl:w-[90%] transform translate-x-28 2xl:translate-x-16" : "px-12 md:px-14 2xl:px-10 md:py-6 2xl:py-8 text-base w-full"}`}>
    
      
      <img src={logoInt} alt={logoInt} className={`transition-all duration-300 ${isScrolled ? "w-28 2xl:w-32" : "w-40 2xl:w-48"}`}/>
