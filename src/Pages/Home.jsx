      ...
      <div className="h-full w-full bg-white">
        <div className="flex flex-col items-center py-28">
          ...
          <div className="grid grid-cols-4 gap-10 px-28">
            <div className="flex flex-col items-center place-content-center border-2 border-green-600 rounded-lg p-4">
            ...
            <div className="flex flex-col items-center place-content-center border-2 border-green-600 rounded-lg p-2">
